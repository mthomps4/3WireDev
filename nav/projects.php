...
<div class="HighlightContainer">
  ...
  <div class="project">
      <img class="projectImg" src="../styles/img/3wirechat.PNG" alt=""/>
    ...
    <div class="project">
        <img class="projectImg" src="../styles/img/Bourbon.JPG" alt=""/>
        <div class="projectBox">
          <div class="codeButtons">
      ...
      <div class="project">
          <img class="projectImg" src="../styles/img/FurnArchive.JPG" alt=""/>
          <div class="projectBox">
            <div class="codeButtons">
...
<!-- https://i.vimeocdn.com/portrait/1408913_300x300 -->
</div>
</div>
